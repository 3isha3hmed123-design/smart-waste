...
-        gemini_error = str(e)
-else:
-    gemini_error = "❌ لم يتم العثور على مفتاح GEMINI_API_KEY في المتغيرات البيئية."
...
+#   المساعدة على التنقل
 ...
 page = st.sidebar.radio(
     "اختر صفحة:",
-    ["الصفحة الرئيسية", "تشاتبوت إعادة التدوير"]
...
+def render_home():
     ...
     st.markdown(
-        '<div class="subtitle">تطبيق ذكي يقدم لك معلومات حول إعادة التدوير وتقليل النفايات.</div>',
-        unsafe_allow_html=True
...
-        if st.button("إرسال"):
-            prompt = (
-                "أنت مساعد متخصص في إعادة التدوير.\n"
-                "أجب بإيجاز وبشكل واضح.\n\n"
